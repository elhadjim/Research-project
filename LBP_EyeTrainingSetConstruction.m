...
windows = 3;   % number of regions per line and per columns (total number of regions = windows²)
...
%% Setting up
facebasedirectory = 'LBP_TrainingSet/Yeux/';
nonfacebasedirectory = 'LBP_TrainingSet/YeuxNon/';
imagetype = '**/*.jpg';
...
for i=1:l_face
    ...
    currentimage = imresize(currentimage, [62 112]);
...
%% Eyes
% Construction of the histograms of eyes
if(faces_trainingset_construction)
    LBP_faceimages = uint8(zeros(sz(1),sz(2),l_face));  % "LBP" images of eyes
...
save('LBP_Eyetraining', 'windows', 'm', 'nbins', 'uniform_patterns', 'weighted', 'firstBar', 'lastBar', 'Mface', 'Mnonface');
